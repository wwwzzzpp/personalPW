...
public class JSONUtils
{
     ...
     *         </ul>
     */
    public static String getStringCascade( String jsonData,
            String defaultValue, String... keyArray )
    {
        if ( StringUtils.isEmpty( jsonData ) )
        {
     ...
     *         </ul>
     */
    public static List<String> getStringList( JSONObject jsonObject,
    ...
    {
        return JSONUtils.parseKeyAndValueToMap( JSONUtils.getString(
                jsonObject, key, null ) );
    }
    ...
    public static Map<String, String> getMap( String jsonData, String key )
    {
        ...
        {
            return new HashMap<String, String>( Constants.INIT_VECTOR_SIZE );
        }
    ...
    public static Map<String, String> parseKeyAndValueToMap(
