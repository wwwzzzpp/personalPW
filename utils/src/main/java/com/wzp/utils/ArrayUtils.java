...
{
    /**
     * @LAST tag for method getLast
     * @NEXT tag for method getNext
     * @author chenmingcan
     * @data 2015.04.25
     */
    enum RequireTag
     ...
     *            whether is circle
     * @return
     * @modify by chenmingcan data 2015.04.25
     */
    public static <V> V getLast( V[] sourceArray, V value, V defaultValue,
            boolean isCircle )
    {
        return getLastNext( sourceArray, value, defaultValue, isCircle,
                RequireTag.LAST );
    }
     ...
     * @param tag
     * @return
     * @added by chenmingcan data 2015.04.25
     */
    public static <V> V getLastNext( V[] sourceArray, V value, V defaultValue,
            boolean isCircle, RequireTag tag )
    {
        ...
        return sourceArray[currentPosition];
    }
